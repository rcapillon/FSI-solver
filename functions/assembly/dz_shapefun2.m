function y = dz_shapefun2(vec_coeffs,vec_Xref)

% 3D shape function derivative with respect to z (for 20-node volumic meshes)
...
vec_OXref = [
             ...
             0 ;
             vec_Xref(2)^2 ;
             2*vec_Xref(3)*vec_Xref(1) ;
             2*vec_Xref(3)*vec_Xref(2) ;
             vec_Xref(1)^2*vec_Xref(2) ;
             vec_Xref(2)^2*vec_Xref(1) ;
             2*vec_Xref(3)*vec_Xref(1)*vec_Xref(2) ;
             ] ;
